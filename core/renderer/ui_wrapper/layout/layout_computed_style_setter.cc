...
SUPPORTED_ENUM_LAYOUT_PROPERTY(SET_ENUM_PROPERTY)
#undef SET_ENUM_PROPERTY

#define SET_LENGTH_PROPERTY(type_name, length, css_type, default_type) \
  bool LayoutComputedStyleSetter::Set##type_name(                      \
      const CSSValue& value, const bool reset,                         \
      const CssMeasureContext& measure_context,                        \
      const CSSParserConfigs& parser_configs,                          \
      starlight::LayoutComputedStyle& computed_style,                  \
...
bool LayoutComputedStyleSetter::SetBoxSizing(
    const tasm::CSSValue& value, const bool reset,
    const CssMeasureContext& measure_context,
    const tasm::CSSParserConfigs& parser_configs,
    starlight::LayoutComputedStyle& computed_style,
    bool css_align_with_legacy_w3c) {
  auto old_value = computed_style.box_sizing_;
  if (reset) {
...
bool LayoutComputedStyleSetter::SetBorderWidth(
    const tasm::CSSValue& value, const bool reset,
    const CssMeasureContext& measure_context,
    const tasm::CSSParserConfigs& parser_configs,
    starlight::LayoutComputedStyle& computed_style,
...
static bool CalculateFromBorderWidthStringToFloat(
  ...
  result = starlight::CSSStyleUtils::GetBorderWidthFromLengthToFloat(
      parse_result.first, context);
  return true;
}
static bool SetBorderWidthHelper(bool cssAlignWithLegacyW3C,
...
bool LayoutComputedStyleSetter::SetBorderLeftWidth(
    const tasm::CSSValue& value, const bool reset,
    const CssMeasureContext& measure_context,
    const tasm::CSSParserConfigs& parser_configs,
    starlight::LayoutComputedStyle& computed_style,
...
bool LayoutComputedStyleSetter::SetBorderRightWidth(
    const tasm::CSSValue& value, const bool reset,
    const CssMeasureContext& measure_context,
    const tasm::CSSParserConfigs& parser_configs,
    starlight::LayoutComputedStyle& computed_style,
...
bool LayoutComputedStyleSetter::SetBorderTopWidth(
    const tasm::CSSValue& value, const bool reset,
    const CssMeasureContext& measure_context,
    const tasm::CSSParserConfigs& parser_configs,
    starlight::LayoutComputedStyle& computed_style,
...
bool LayoutComputedStyleSetter::SetPadding(
    const tasm::CSSValue& value, const bool reset,
    const CssMeasureContext& measure_context,
    const tasm::CSSParserConfigs& parser_configs,
    starlight::LayoutComputedStyle& computed_style,
...
bool LayoutComputedStyleSetter::SetMargin(
    const tasm::CSSValue& value, const bool reset,
    const CssMeasureContext& measure_context,
    const tasm::CSSParserConfigs& parser_configs,
    starlight::LayoutComputedStyle& computed_style,
...
bool LayoutComputedStyleSetter::SetFlex(
    const tasm::CSSValue& value, const bool reset,
    const CssMeasureContext& measure_context,
    const tasm::CSSParserConfigs& parser_configs,
    starlight::LayoutComputedStyle& computed_style,
...
bool LayoutComputedStyleSetter::SetBorder(
    const tasm::CSSValue& value, const bool reset,
    const CssMeasureContext& measure_context,
    const tasm::CSSParserConfigs& parser_configs,
    starlight::LayoutComputedStyle& computed_style,
...
bool LayoutComputedStyleSetter::SetBorderRight(
    const tasm::CSSValue& value, const bool reset,
    const CssMeasureContext& measure_context,
    const tasm::CSSParserConfigs& parser_configs,
    starlight::LayoutComputedStyle& computed_style,
...
bool LayoutComputedStyleSetter::SetBorderLeft(
    const tasm::CSSValue& value, const bool reset,
    const CssMeasureContext& measure_context,
    const tasm::CSSParserConfigs& parser_configs,
    starlight::LayoutComputedStyle& computed_style,
...
bool LayoutComputedStyleSetter::SetBorderTop(
    const tasm::CSSValue& value, const bool reset,
    const CssMeasureContext& measure_context,
    const tasm::CSSParserConfigs& parser_configs,
    starlight::LayoutComputedStyle& computed_style,
...
bool LayoutComputedStyleSetter::SetBorderBottom(
    const tasm::CSSValue& value, const bool reset,
    const CssMeasureContext& measure_context,
    const tasm::CSSParserConfigs& parser_configs,
    starlight::LayoutComputedStyle& computed_style,
...
bool LayoutComputedStyleSetter::SetContent(
    const tasm::CSSValue& value, const bool reset,
    const CssMeasureContext& measure_context,
    const tasm::CSSParserConfigs& parser_configs,
    starlight::LayoutComputedStyle& computed_style,
...
bool LayoutComputedStyleSetter::SetGridTemplateRows(
    const tasm::CSSValue& value, const bool reset,
    const CssMeasureContext& measure_context,
    const tasm::CSSParserConfigs& parser_configs,
    starlight::LayoutComputedStyle& computed_style,
...
bool LayoutComputedStyleSetter::SetGridAutoColumns(
    const tasm::CSSValue& value, const bool reset,
    const CssMeasureContext& measure_context,
    const tasm::CSSParserConfigs& parser_configs,
    starlight::LayoutComputedStyle& computed_style,
...
bool LayoutComputedStyleSetter::SetGridAutoRows(
    const tasm::CSSValue& value, const bool reset,
    const CssMeasureContext& measure_context,
    const tasm::CSSParserConfigs& parser_configs,
    starlight::LayoutComputedStyle& computed_style,
...
bool LayoutComputedStyleSetter::SetListCrossAxisGap(
    const CSSValue& value, const bool reset,
    const CssMeasureContext& measure_context,
    const CSSParserConfigs& parser_configs,
    starlight::LayoutComputedStyle& computed_style,
...
bool LayoutComputedStyleSetter::SetGap(
    const CSSValue& value, const bool reset,
    const CssMeasureContext& measure_context,
    const CSSParserConfigs& parser_configs,
    starlight::LayoutComputedStyle& computed_style,
...
bool LayoutComputedStyleSetter::SetColumnGap(
    const CSSValue& value, const bool reset,
    const CssMeasureContext& measure_context,
    const CSSParserConfigs& parser_configs,
    starlight::LayoutComputedStyle& computed_style,
    bool css_align_with_legacy_w3c) {
  return SetGridColumnGap(value, reset, measure_context, parser_configs,
                          computed_style);
}

bool LayoutComputedStyleSetter::SetRowGap(
    const tasm::CSSValue& value, const bool reset,
    const CssMeasureContext& measure_context,
    const tasm::CSSParserConfigs& parser_configs,
    starlight::LayoutComputedStyle& computed_style,
    bool css_align_with_legacy_w3c) {
  return SetGridRowGap(value, reset, measure_context, parser_configs,
                       computed_style);
}

using SetterFunc = bool (*)(const tasm::CSSValue& value, const bool reset,
                            const CssMeasureContext& measure_context,
                            const tasm::CSSParserConfigs& parser_configs,
                            starlight::LayoutComputedStyle& computed_style,
                            bool css_align_with_legacy_w3c);
...
bool LayoutComputedStyleSetter::SetValue(
    CSSPropertyID id, const CSSValue& value, bool reset,
    const CssMeasureContext& measure_context,
    const tasm::CSSParserConfigs& parser_configs,
    starlight::LayoutComputedStyle& computed_style,
    bool css_align_with_legacy_w3c) {
  if (id > kPropertyStart && id < kPropertyEnd) {
    if (SetterFunc setter = kWriter[id]) {
      return setter(value, reset, measure_context, parser_configs,
                    computed_style, css_align_with_legacy_w3c);
    }
  }
  return false;
}
