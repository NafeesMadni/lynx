...
""")
  ...
  """
    return define_template.substitute(
        css=css_str), css_java_str, css_java_constant_str,  layout_macro_template.substitute(css=layout_macro_str)


def genCSSProperty(json_obj):
    css_properties, css_java_properties, css_java_constant_properties, layout_properties_macro = gen(
        json_obj)
